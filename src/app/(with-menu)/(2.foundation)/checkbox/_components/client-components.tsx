...
import { Card, Checkbox, CheckboxProps, Section, Space, Text } from "@/components/atoms";
  ...
  return (
    <Section>
      ...
      <Card
        title={"Group"}
        actions={[
          <Checkbox indeterminate={indeterminate} checked={checkAll} onChange={onChangeAll} key={1}>
